...
def decide_action(alertness, hypertension, intoxication, time_since_slept, time_elapsed, work_done):
    ...
    if hypertension > 0.012 or intoxication > 0.04 or alertness < 0.5 or time_since_slept > 5:
        return 3
    ...
    if alertness > 0.6 and time_elapsed % 250 == 0 and hypertension < 0.007 and intoxication < 0.01:
        return 2
