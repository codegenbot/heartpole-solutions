...
def decide_action(alertness, hypertension, intoxication, time_since_slept, time_elapsed, work_done):
    ...
    if alertness < 0.3 or hypertension > 0.7 or intoxication > 0.4 or time_since_slept > 5:
        return 3  # Prioritize sleep

    # Use coffee only when alertness is low but within safe hypertension & intoxication levels
    ...
    # Risk of stress and intoxication handled by beer, but tune the condition
    if hypertension < 0.65 and intoxication < 0.5:
