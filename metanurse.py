...
def decide_action(
    ...
    # Prioritize sleep under critical conditions
    if (
        alertness < 0.5
        or hypertension >= 0.6
        or intoxication >= 0.4
    ...
    # Drink coffee if alertness needs boost and it’s safe
    if alertness < 0.7 and hypertension < 0.35 and intoxication < 0.15:
        return 1  # Drink coffee and work

    # Use beer very sparingly for relaxation in particularly safe scenarios
