...
def decide_action(alertness, hypertension, intoxication, time_since_slept, time_elapsed, work_done):
    ...
    if intoxication <= 0.2 and alertness < 0.5 and work_done < 0.5 and time_elapsed < 10:
        return 2
    
    # Work if metrics show reasonable health and productive measures
    if alertness >= 0.4 and hypertension <= 0.2 and intoxication <= 0.2 and work_done < 0.8:
        return 0
