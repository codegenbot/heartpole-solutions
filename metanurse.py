...
def decide_action(
    ...
    # Adjusting thresholds for better prioritization of rest:
    if hypertension > 0.4 or intoxication > 0.2 or time_since_slept > 4:
        return 3  # Sleep
    ...
    return 3  # Default to sleeping for recovery
