...
def decide_action(alertness, hypertension, intoxication, time_since_slept, time_elapsed, work_done):
    # Prioritize sleeping if any threshold is dangerously unhealthy
    if hypertension > 0.9 or intoxication > 0.9 or time_since_slept > 16:
        return 3  # Sleep

    # Adjust alertness thresholds and prioritize coffee/beer based on current states
    ...
    # Default to sleep if no other action is strongly suggested
    return 3  # Sleep
