...
def decide_action(alertness, hypertension, intoxication, time_since_slept, time_elapsed, work_done):
    # Prioritize sleep more strictly if conditions are critical
    if alertness < 0.3 or time_since_slept > 6 or hypertension >= 0.15 or time_elapsed > 5:
        return 3
    
    # Use coffee with less strict criteria to boost alertness if health risks are minimal
    ...
    # Default to work if no strong inclination for other actions
    return 0
